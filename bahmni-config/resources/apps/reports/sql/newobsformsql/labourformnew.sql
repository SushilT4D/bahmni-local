  ...
  (
    ...
    JOIN concept_name obs_fscn on o.concept_id=obs_fscn.concept_id AND obs_fscn.concept_name_type="FULLY_SPECIFIED" AND obs_fscn.voided is false
     AND obs_fscn.name IN ('Del_Date_of_Admission','Del_Gravida','Del_Parity','Del_Abortions','Del_Live_Births','Del_Still_Births','Del_Neonatal_Death','Global_weight','Del_Height','Del_Hemoglobin',
        'HIV Status new','ANC_High_risk','Del_Any_High_risk','Del_Outcome','Del_specify_reason','Del_Delivery_Date','Global_Location_Visit','Del_complications_in_delivery','Del_Specify_complications','Del_Outcome_Delivery',
        'Del_Period_Of_Gestation','Del_N_born_sex','Del_Newborn_Weight','Del_Type_of_Birth','Del_LowBirth_Weight','Del_ANY_Newborn_Compli','Del_Newborn_complication',
        'GLOBAL_Patient_Admitted','Consulted on Call','Receipt_number','Fees_Amount',   'GLOBAL_Doctors_Name','GLOBAL_Nurse_Name')
