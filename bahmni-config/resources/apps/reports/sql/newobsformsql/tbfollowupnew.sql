  ...
  (
   ...
   FROM obs o
    ...
    JOIN concept_name obs_fscn on o.concept_id=obs_fscn.concept_id AND obs_fscn.concept_name_type="FULLY_SPECIFIED" AND obs_fscn.voided is false
     AND obs_fscn.name IN ('Location of Visit','Phulwari_Text','OutReach_Text','TB_FollowUP_Weight','HIV Status new','TB_Intake_other_diagnosis','RF_Institute_Name','Consulted on Call','Subscription card','Subscription card Numbers','TB_Hemoglobin','TB_Sputum_Outcome','TB_2_CBNAAT_Culture_Outcome','TB_LPA_Outcome','TB_Intake_Any_Other_Diagnosis',
     'TB_Severe_Illness','Patient referred_institute','GLOBAL_Patient_Admitted','Receipt_number','Fees_Amount','GLOBAL_Doctors_Name','GLOBAL_Nurse_Name')
