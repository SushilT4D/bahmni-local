 ...
 paddress.state_province as 'State',
  ...
  paddress.postal_code  as 'Hamlet (Fala)'
    ...
    JOIN concept_name obs_fscn on o.concept_id=obs_fscn.concept_id AND obs_fscn.concept_name_type="FULLY_SPECIFIED" AND obs_fscn.voided is false
     AND obs_fscn.name IN ('TB_Intake_Any_Other_Diagnosis','RF_Institute_Name','GLOBAL_Doctors_Name','GLOBAL_Nurse_Name')
 ...
 paddress.state_province as 'State',
  ...
  paddress.postal_code  as 'Hamlet (Fala)'
    ...
    JOIN concept_name obs_fscn on o.concept_id=obs_fscn.concept_id AND obs_fscn.concept_name_type="FULLY_SPECIFIED" AND obs_fscn.voided is false
     ...
     'TB_Intake_Any_Other_Diagnosis','TB_Severe_Illness','TB_Need_for_Referral','RF_Institute_Name','Receipt_number','Fees_Amount','Consulted on Call','Subscription card','Subscription card Numbers','GLOBAL_FollowUpDate',
